...
optimSolFound2, Pd2, Pch2, Pdch2, Es2, Psh, Pdr, totalCost2 = optimalSolutionScenario2(loadPower, pvPower, priceCreg)
if optimSolFound2:
    exportResults("scenario2.csv",Pch1, Pdch1, Pd1)
    prepareFigureScenario2(loadDate, totalCost2, priceCreg, pvPower, loadPower, Pd2, Pch2, Pdch2, Es2, Psh, Pdr, typicalLoadCurve)
